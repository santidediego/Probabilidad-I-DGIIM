...
\item La ley normal $N(0,1)$ de una variable aleatoria normal con su derivada definida viene dada por:
$$F(x)=\frac{1}{\sqrt{2\pi}}\int_{-x}^{x}e^{-\frac{1}{2}y^2}dy$$
\item La ley de Poisson $\mathcal{P}(\lambda)$ de una variable aleatoria de Poisson con derivada definida viene dada por:
