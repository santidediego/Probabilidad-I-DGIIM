...
\end{proof}
De este criterio podemos deducir una ley muy importante, la Ley cero-uno de Kolmogorov
\subsection{Ley cero-uno de Kolmogorov}
...
FALTA LA PARTE PREELIMINAR
\subsection{Teorema de representación}
\begin{theorem}
La familia de funciones características idénticamente distribuidas coincide con la familia de funciones características de la forma $e^\phi$
\end{theorem}
\begin{proof}
