...
\end{proof}
\subsubsection{Criterio 0-1 de Borel}
\begin{lemma}
Criterio 0-1 de Borel
\\\\
Sea $(\Omega,\mathcal{A},P) \, , \, A_n \in \mathcal{A}$ independientes. Entonces:
\begin{itemize}
\item Si $\displaystyle\sum P \, A_n < \infty \Longrightarrow P(\displaystyle \lim_{sup}A_n)=0$
\item Si $\sum P(A_k)=\infty \Longrightarrow P(\displaystyle \lim_{sup}A_n)=1$
\end{itemize}
\end{lemma}
